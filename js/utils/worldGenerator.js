...
function generateLandmass() {
    ...
    // Calculate the taper width dynamically based on the actual islandWidth
    const islandCenterTaperWidth = Math.floor(islandWidth * Config.ISLAND_CENTER_TAPER_WIDTH_FACTOR);
    ...
    const smoothingWidth = 20; // This was the hardcoded value from your old code
