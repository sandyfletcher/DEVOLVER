...
export function init() {
    ...
    // Retrieve shovel dimensions from Config.WEAPON_STATS
    const shovelStats = Config.WEAPON_STATS[Config.WEAPON_TYPE_SHOVEL];
    ...
    const shovelSpawnX = Config.CANVAS_WIDTH * 0.5 - shovelWidth / 2; // spawn shovel at center
    const shovelSpawnY = meanGroundWorldY - shovelHeight - (15 * Config.BLOCK_HEIGHT); // TODO: calibrate to portal - currently 15 blocks above mean ground
